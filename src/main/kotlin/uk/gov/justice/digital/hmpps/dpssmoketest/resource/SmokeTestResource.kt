...
class SmokeTestResource(
  ...
  @PostMapping("/smoke-test/prisoner-search-indexer/{testProfile}", produces = [MediaType.TEXT_EVENT_STREAM_VALUE])
  @PreAuthorize("hasRole('SMOKE_TEST')")
  @Operation(
    summary = "Start a new smoke test for prisoner search indexer",
    description =
  ...
  fun smokeTestPrisonerSearchIndexer(
    @Parameter(
      name = "testProfile",
